...
public class openCVChooserPanel extends AbstractColorChooserPanel implements ActionListener {
    private float h,s,v = 0;
    private double nH, nS, nV = 0;
    private int r,g,b = 0;
    private float[] hsv = new float[3];
    private openCVPanel openCV;
    ...
    openCVChooserPanel(openCVPanel openCV){
        this.openCV = openCV;
    }
